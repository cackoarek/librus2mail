...
3. **No unattended live testing**:
   - Running `main.py` directly executes live scraping against Librus Synergia and may dispatch actual emails to real recipient addresses configured in local YAML files.
   - Never invoke `python main.py` in background tasks or during autonomous verification without explicit user instructions.
